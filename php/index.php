...
<body class="">
 <!-- carica -->
  <div class="modal fade" id="carica" tabindex="-1" role="dialog" aria-labelledby="carica" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title" id="carica">Carica</h4>
            </div>
            ...
            <section>
              <section class="vbox">
                <section class="scrollable padder-lg w-f-md" id="bjax-target">
                  ...
                  <h2 class="font-thin m-b">Playlist più votate per della settimana <span class="musicbar animate inline m-l-sm" style="width:20px;height:20px">
                  ...
                  <div class="row">
                    <div class="col-md-7">
                      <h3 class="font-thin">Nuove Playlist</h3>
                      <div class="row row-sm">
